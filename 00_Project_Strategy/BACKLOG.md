...
**Progress:** 17/42 items done (40%) | P0: 6/9 | P1: 11/16 | P2: 0/13 | P3: 0/4
...
| ID | Title | Effort | Status | Description |
|----|-------|--------|--------|-------------|
| chipsoft-security | ChipSoft A2A Security Post | M | ❌ | LinkedIn post on A2A protocol security findings from Mordred red-team scenario |
| citizen-agents | Citizen Agent Architecture | L | 🟡 | LLM-powered citizen agents for SOLL mode (see docs/CITIZEN_AGENT_ARCH.md) |
